...
public class EditStock_K extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTableK;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock__k);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTableK = (TableLayout)findViewById(R.id.editStockTableK);

        try{
            for(int i = 2, j = AisleK_Check.stockCheckTableK.getChildCount(); i < j; i++){
                TableRow tempRow = (TableRow)AisleK_Check.stockCheckTableK.getChildAt(i);
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle K
                        if(aisle.getText().toString().equals("J")){
                            ...
                            MainActivity.aisleK.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTableK.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_K.this);
            ...
            Toast.makeText(EditStock_K.this, "System error", Toast.LENGTH_LONG).show();
