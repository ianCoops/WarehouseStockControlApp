...
public class EditStock_M extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTableM;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock__m);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTableM = (TableLayout)findViewById(R.id.editStockTableM);

        try{
            for(int i = 2, j = AisleM_Check.stockCheckTableM.getChildCount(); i < j; i++){
                TableRow tempRow = (TableRow)AisleM_Check.stockCheckTableM.getChildAt(i);
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle M
                        if(aisle.getText().toString().equals("M")){
                            ...
                            MainActivity.aisleM.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTableM.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_M.this);
            ...
            Toast.makeText(EditStock_M.this, "System error", Toast.LENGTH_LONG).show();
