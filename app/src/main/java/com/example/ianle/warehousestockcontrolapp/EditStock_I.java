...
public class EditStock_I extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTableI;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock__i);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTableI = (TableLayout)findViewById(R.id.editStockTableI);

        try{
            for(int i = 2, j = AisleI_Check.stockCheckTableI.getChildCount(); i < j; i++){
                TableRow tempRow = (TableRow)AisleI_Check.stockCheckTableI.getChildAt(i);
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle I
                        if(aisle.getText().toString().equals("I")){
                            ...
                            MainActivity.aisleI.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTableI.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_I.this);
            ...
            Toast.makeText(EditStock_I.this, "System error", Toast.LENGTH_LONG).show();
