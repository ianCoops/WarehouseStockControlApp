...
public class EditStock_G extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTable;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock_g);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTable = (TableLayout)findViewById(R.id.editStockTable);

        try{
            // Iterate over the final table from the stock check of Aisle G
            for(int i = 2, j = AisleG_Check.stockCheckTable.getChildCount(); i < j; i++){
                // Declare new Table Row
                TableRow tempRow = (TableRow)AisleG_Check.stockCheckTable.getChildAt(i);
                // Declare the new row
                final TableRow row = new TableRow(this);
                // Set the parameters for the new row
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle G
                        if(aisle.getText().toString().equals("G")){
                            ...
                            MainActivity.aisleG.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTable.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_G.this);
                    ...
                    builder.setMessage("Please edit the information in the table" + "\n"
                                        ...
                                        + "please press the OK button at the end of each row.");
            ...
            Toast.makeText(EditStock_G.this, "System error", Toast.LENGTH_LONG).show();
