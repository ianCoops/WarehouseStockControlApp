...
public class EditStock_L extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTableL;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock__l);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTableL = (TableLayout)findViewById(R.id.editStockTableL);

        try{
            for(int i = 2, j = AisleL_Check.stockCheckTableL.getChildCount(); i < j; i++){
                TableRow tempRow = (TableRow)AisleL_Check.stockCheckTableL.getChildAt(i);
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle L
                        if(aisle.getText().toString().equals("L")){
                            ...
                            MainActivity.aisleL.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTableL.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_L.this);
            ...
            Toast.makeText(EditStock_L.this, "System error", Toast.LENGTH_LONG).show();
