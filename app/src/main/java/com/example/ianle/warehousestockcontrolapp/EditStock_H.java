...
public class EditStock_H extends AppCompatActivity {

    Button helpButton;
    TableLayout editStockTableH;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_stock__h);

        helpButton = (Button)findViewById(R.id.helpButton);
        editStockTableH = (TableLayout)findViewById(R.id.editStockTableH);

        try{
            for(int i = 2, j = AisleH_Check.stockCheckTableH.getChildCount(); i < j; i++){
                TableRow tempRow = (TableRow)AisleH_Check.stockCheckTableH.getChildAt(i);
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // If new stock details need to be located in aisle H
                        if(aisle.getText().toString().equals("H")){
                            ...
                            MainActivity.aisleH.getLevel(level.toString())[loc] = tempPallet;
                            // Update activity log
                            Date date2 = new Date();
                ...
                editStockTableH.addView(row);
            }

            helpButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditStock_H.this);
            ...
            Toast.makeText(EditStock_H.this, "System error", Toast.LENGTH_LONG).show();
